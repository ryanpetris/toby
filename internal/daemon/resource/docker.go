...
// DockerRunner: the container backend that runs MCP sidecars via
// testcontainers-go — building stdio/http container requests, attaching to
// stdio servers, eagerly starting http servers to discover their mapped port,
// and producing the ProcessHandle the lifecycle drives.
