...
// Format identifies a supported configuration serialization format.
type Format int

const (
	// FormatJSON selects JSON decoding.
	FormatJSON Format = iota
	// FormatYAML selects YAML decoding.
	FormatYAML
)
...
// CloneMap returns a deep copy of a generic configuration map.
...
// Clone returns a deep copy of a generic configuration value.
