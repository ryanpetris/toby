// Package sessionresolve produces the sandbox-safe sessionconfig.Config for a
...
func (r *Resolver) resolve(ctx context.Context, lctx lifecycle.Context) (sessionconfig.Config, error) {
	controlHost, _ := r.sandbox.GetEnvironment(control.EnvControlHost)
...
func (r *Resolver) fetchModels(ctx context.Context, provider tobyconfig.ProviderConfig, headers http.Header) (map[string]any, error) {
