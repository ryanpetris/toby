...
func (s *instance) containerRequest(spec sandbox.RunSpec, phase phaseKind, class engine.DaemonClass) testcontainers.GenericContainerRequest {
...
func (s *instance) Prime(ctx context.Context, spec sandbox.RunSpec) (int, error) {
	...
	class, err := s.containers.GetDaemonClass(ctx)
	if err != nil {
		return 1, err
	}
