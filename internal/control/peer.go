...
// Peer is a bidirectional JSON-RPC peer over a control connection: it writes
// newline-framed requests, matches responses back to their callers by id, and
// dispatches inbound requests to a handler. Both host and sandbox sides run one.
