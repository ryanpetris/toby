...
func Metadata() []tool.Metadata {
	items := []tool.Metadata{
		...
		{Name: tool.ClaudeToolName, LaunchHelp: "Launch Claude", ContextGroups: []string{tool.GroupSystem, tool.GroupVCS}, Dependencies: []string{tool.NpmToolName}, Priority: 100},
		{Name: tool.CopilotToolName, LaunchHelp: "Launch Copilot", ContextGroups: []string{tool.GroupSystem, tool.GroupVCS}, Dependencies: []string{tool.NpmToolName}, Priority: 100},
		{Name: tool.CodexToolName, LaunchHelp: "Launch Codex", ContextGroups: []string{tool.GroupSystem, tool.GroupVCS}, Dependencies: []string{tool.NpmToolName}, Priority: 100},
