...
- `git_commit`: commit staged files in a visible repository using host Git.
- `git_fetch`: fetch remote refs in a visible repository using host Git.
- `git_push`: push one branch from a visible repository using host Git.
