...
// Tests provider registration and model lookup dispatch.
...
func TestRegistryPerformsEveryLookup(t *testing.T) {
...
func TestRegistryDispatchesLookupArguments(t *testing.T) {
	client := &countingClient{kind: KindOpenAI, models: []Model{{ID: "a", DisplayName: "a"}}}
	registry := NewRegistry([]Client{client})
