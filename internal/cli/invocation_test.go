...
func TestIsConfigFreeInvocation(t *testing.T) {
	tests := []struct {
		...
		{name: "approvals list", arguments: []string{"approvals"}, want: true},
		{name: "approvals prompt", arguments: []string{"approvals", "a1b2c3d4e5f6"}, want: true},
		{name: "approvals approve", arguments: []string{"approvals", "a1b2c3d4e5f6", "approve"}, want: true},
		{name: "approvals deny", arguments: []string{"approvals", "a1b2c3d4e5f6", "deny"}, want: true},
