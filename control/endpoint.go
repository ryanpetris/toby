...
// Endpoint addresses the control channel — the listen/host address and auth token —
// and builds the control (WebSocket), binary, and proxy URLs the sandbox uses to
// reach the host.
