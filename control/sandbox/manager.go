...
// Runtime is the in-sandbox control endpoint: it dials the host, drives the
...
func (r *Runtime) getEnvironment(name string) (string, bool) { return r.env.Get(name) }

func (r *Runtime) setEnvironment(name, value string) { r.env.Set(name, value) }
