// Package files implements the file.* control methods — creating, deleting,
// mkdir'ing, and symlinking paths inside the sandbox. It is stateless: handlers
// operate directly on the filesystem, so the capability holds no dependencies.
package files
...
// Service handles the file.* methods.
type Service struct{}

var _ control.Capability = Service{}

// New constructs the stateless file capability.
func New() Service { return Service{} }

// Methods reports the file.* methods this capability handles.
