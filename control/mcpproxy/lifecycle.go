...
// Sidecar lifecycle: starting, stopping, and restarting a local entry's
// process, tracking its status transitions and attaching the stdio bridge once
// the handle is running.
