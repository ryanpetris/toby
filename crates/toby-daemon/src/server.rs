...
#[utoipa::path(get, path = "/v1/daemon", tag = "daemon", responses((status = 200, body = api::DaemonInfo), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/machines/{id}/attachments", tag = "machines", params(("id" = String, Path)), request_body = api::AddAttachment, responses((status = 200, body = api::AttachmentInfo), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(delete, path = "/v1/machines/{id}/attachments/{aid}", tag = "machines", params(("id" = String, Path), ("aid" = String, Path)), responses((status = 200, description = "Done", body = serde_json::Value, example = json!(null)), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/machines/{id}/forwards", tag = "machines", params(("id" = String, Path)), request_body = api::AddForward, responses((status = 200, body = api::ForwardInfo), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(delete, path = "/v1/machines/{id}/forwards/{fid}", tag = "machines", params(("id" = String, Path), ("fid" = String, Path)), responses((status = 200, description = "Done", body = serde_json::Value, example = json!(null)), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/machines/{id}/tools/{name}/prepare", tag = "machines", params(("id" = String, Path), ("name" = String, Path)), request_body = api::PrepareTool, responses((status = 200, body = api::BuildStarted), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/sessions", tag = "sessions", request_body = api::CreateSession, responses((status = 200, body = api::SessionCreated), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(get, path = "/v1/sessions", tag = "sessions", responses((status = 200, body = Vec<api::MachineSession>), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/sessions/{id}/kill", tag = "sessions", params(("id" = String, Path)), request_body = api::KillSession, responses((status = 200, description = "Done", body = serde_json::Value, example = json!(null)), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(get, path = "/v1/images", tag = "images", responses((status = 200, body = Vec<api::ImageInfo>), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(delete, path = "/v1/images/{id}", tag = "images", params(("id" = String, Path)), responses((status = 200, description = "Done", body = serde_json::Value, example = json!(null)), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/images/prune", tag = "images", responses((status = 200, body = api::Pruned), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/builds", tag = "images", request_body = api::StartBuild, responses((status = 200, body = api::BuildStarted), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/bootstrap", tag = "images", request_body = api::Bootstrap, responses((status = 200, body = api::BuildStarted), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(get, path = "/v1/builds/{id}", tag = "images", params(("id" = String, Path)), responses((status = 200, body = api::BuildStatus), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(get, path = "/v1/roots", tag = "roots", responses((status = 200, body = Vec<api::RootInfo>), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/roots/{name}/reset", tag = "roots", params(("name" = String, Path)), responses((status = 200, description = "Done", body = serde_json::Value, example = json!(null)), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
async fn reset_root(State(d): Shared, Path(name): Path<String>) -> ApiResult<()> {
    d.builder.store.reset_root(&name).await?;
    Ok(Json(()))
}

#[utoipa::path(post, path = "/v1/roots/{name}/rebase", tag = "roots", params(("name" = String, Path)), request_body = api::Rebase, responses((status = 200, description = "Done", body = serde_json::Value, example = json!(null)), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(delete, path = "/v1/roots/{name}", tag = "roots", params(("name" = String, Path)), responses((status = 200, description = "Done", body = serde_json::Value, example = json!(null)), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(get, path = "/v1/homes", tag = "homes", responses((status = 200, body = Vec<api::HomeInfo>), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/homes", tag = "homes", request_body = api::CreateHome, responses((status = 200, body = api::BuildStarted), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(post, path = "/v1/versions/gc", tag = "daemon", responses((status = 200, body = api::VersionsCollected), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
#[utoipa::path(get, path = "/v1/machines/{id}/logs", tag = "machines", params(("id" = String, Path)), responses((status = 101, description = "A WebSocket of log lines"), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
async fn machine_logs(
    ...
    Ok(ws.protocols(["toby"]).on_upgrade(move |socket| crate::logs::machine(d, id, socket)))
}

#[utoipa::path(get, path = "/v1/mcp", tag = "mcp", responses((status = 200, body = Vec<api::McpInfo>), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
...
async fn mcp_logs(
    ...
    ws.protocols(["toby"]).on_upgrade(move |socket| crate::logs::mcp(d, name, socket))
}

#[utoipa::path(post, path = "/v1/web/token", tag = "daemon", responses((status = 200, body = api::WebToken), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
async fn web_token(State(d): Shared) -> ApiResult<api::WebToken> {
    let url = d.web.login_url(d.clone()).await?;
    Ok(Json(api::WebToken { url }))
}

#[utoipa::path(get, path = "/v1/events", tag = "daemon", responses((status = 101, description = "A WebSocket of events", body = api::Event), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
async fn events(State(d): Shared, ws: axum::extract::WebSocketUpgrade) -> Response {
    ws.protocols(["toby"]).on_upgrade(move |socket| crate::events::serve(d, socket))
}

#[utoipa::path(get, path = "/v1/builds", tag = "images", responses((status = 200, body = Vec<api::BuildStatus>), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
pub(crate) async fn builds(State(d): Shared) -> ApiResult<Vec<api::BuildStatus>> {
    Ok(Json(d.builds.list().iter().map(|b| b.status()).collect()))
}

#[utoipa::path(get, path = "/v1/approvals", tag = "approvals", responses((status = 200, body = Vec<api::ApprovalInfo>), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
    ...
    Ok(Json(
        list.into_iter()
            .map(|a| api::ApprovalInfo {
                ...
                machine: a.machine,
                kind: a.kind,
                summary: api::clean_text(&a.summary),
                detail: api::clean_text(&a.detail),
                status: a.status,
            })
            .collect(),
    ))
...
#[utoipa::path(post, path = "/v1/approvals/{id}", tag = "approvals", params(("id" = String, Path)), request_body = api::Decide, responses((status = 200, description = "Done", body = serde_json::Value, example = json!(null)), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
async fn decide(
    State(d): Shared,
    Path(id): Path<String>,
    web: Option<axum::Extension<crate::web::FromWeb>>,
    Json(req): Json<api::Decide>,
) -> ApiResult<()> {
    ...
    let from = match (web, req.from.as_deref()) {
        (Some(_), _) => "web",
        (None, None | Some("cli")) => "cli",
        (None, Some("overlay")) => "overlay",
        (None, Some(_)) => return Err(bad("approval.invalid", "from must be cli or overlay")),
    };
    d.approvals.decide(&id, approve, from)?;
    Ok(Json(()))
}

#[utoipa::path(delete, path = "/v1/homes/{name}", tag = "homes", params(("name" = String, Path)), responses((status = 200, description = "Done", body = serde_json::Value, example = json!(null)), (status = "4XX", body = api::ApiError), (status = "5XX", body = api::ApiError)))]
