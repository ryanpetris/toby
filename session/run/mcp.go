...
func registerTobyMCPProxy(params Params, manager *host.Service, opts *tools.Options, activeTools []string, primary string) (string, error) {
	...
	return params.SandboxService.ProxyBaseURL(id), nil
}
