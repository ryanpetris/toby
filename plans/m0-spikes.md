...
| an Arch Linux Dockerfile (the project's development image of the time: `archlinux:base-devel` plus about 20 packages) via `buildah build --layers` (2.0 GiB) | 33 s | 13 s (pacman: kernel, dracut) | 6.4 s | boots; `99toby` unit ran |
