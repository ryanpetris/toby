...
// achieves the same injection OpenCode gets from its merged opencode.json. The
// input is the pre-resolved, sandbox-safe sessionconfig.Config; this package
// never sees the raw host config, the proxy, or any credential.
package config
